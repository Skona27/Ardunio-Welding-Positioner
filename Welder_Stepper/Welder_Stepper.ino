...
#define PUL_OUT   13  // Pulse
#define DIR_OUT   12  // Direction
#define EN_OUT    11  // On-Off
#define PAUSE_IN  3   // Pause BTN
...
void UpdateDisplay()
{
  ...
  else
  {
    ...
    switch(settings[settings_sub_menu].displayType)
    {
      ...
      case DIS_YESNO:
      (settings[settings_sub_menu].currentValue > 0) ? bottomLine = ("TAK") : bottomLine = ("NIE");
      break;
      
      case DIS_T1F0:
      (settings[settings_sub_menu].currentValue > 0) ? bottomLine = ("PRAWDA") : bottomLine = ("FALSZ");
      break;
